...
angular.module('NileArtGallery').controller('HomeController', ['$scope', function($scope) {
  ...
  function getSlide(target, style) {
    ...
    return {
      id: (i + 1),
      label: 'slide #' + (i + 1),
      img: 'http://mosalem.xyz/' + style + '/' + ((i + 1) % 10),
  ...
  // 2nd ngRepeat demo
  $scope.slides2 = [
    'http://mosalem.xyz/slides/1.JPG',
    'http://mosalem.xyz/slides/2.JPG',
    'http://mosalem.xyz/slides/3.JPG',
    'http://mosalem.xyz/slides/4.JPG'
  ];
  // addSlides($scope.slides2, 'slides', 10);
